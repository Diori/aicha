    ...
    return (
        <div className="home__user__main">
            <div className="partie1">
                <img src='../icons/nurese.jpg' alt='oups!!!' className='icon__homeuser'></img>
            </div>
            <div className="partie2">
                <div className='en__tete__user'>
                        <div className='info__user'>
                            <ul className='ul__infouser'>
                                <li><strong>âges :</strong> 25ans</li>
                                <li><strong>Adresse :</strong> Yoff</li>
                                <li><strong>téléphone :</strong> 780170884</li>
                                <li><strong>Groupe sangain :</strong> O+</li>
                                <li><strong>Nombre de Vaccin:</strong> 1/2</li>
                            </ul>
                        </div>
                        <div className='photo__text'>
                            ...
                            <h3 className='h3__user__name'>Abdel Nasser SALEY DIORI</h3>
                        </div>
                </div>
                <div className='teche__user'>
                <button className="button1 button4 button3">Test</button>
